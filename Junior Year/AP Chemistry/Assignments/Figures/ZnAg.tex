...
\draw    (378,162) .. controls (380.93,138.6) and (355.33,157.03) .. (334.59,170.01) ;
\draw [shift={(333,171)}, rotate = 328.24] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
% Text Node
\draw (151,208) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle Zn$};
% Text Node
\draw (380,165) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle Ag^{+}$};
% Text Node
\draw (293,206) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle Ag$};
% Text Node
\draw (91,151) node [anchor=south] [inner sep=0.75pt]   [align=left] {$\displaystyle Zn^{2+}$};
% Text Node
