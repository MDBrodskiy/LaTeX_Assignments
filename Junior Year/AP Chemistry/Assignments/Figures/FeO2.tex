...
% Text Node
\draw (144,208) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle Fe^{2+}$};
% Text Node
\draw (380,165) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle O_{2}$};
% Text Node
\draw (293,206) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle H^{+}$};
% Text Node
\draw (91,151) node [anchor=south] [inner sep=0.75pt]   [align=left] {$\displaystyle Fe^{3+}$};
% Text Node
...
% Text Node
\draw (365,261) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle H_{2} O$};
