...
\draw    (378,162) .. controls (351.27,180.81) and (352.96,118.27) .. (333.59,169.42) ;
\draw [shift={(333,171)}, rotate = 290.32] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
%Shape: Boxed Bezier Curve [id:dp3798119968280331] 
\draw    (84.27,270) .. controls (111.14,251.09) and (160.77,207.44) .. (100.19,174.5) ;
\draw [shift={(99.27,174)}, rotate = 388.02] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (152,209) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle I^{-}$};
% Text Node
\draw (380,165) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle Br_{2}$};
% Text Node
\draw (293,206) node [anchor=north west][inner sep=0.75pt]   [align=left] {$\displaystyle Br^{-}$};
% Text Node
...
% Text Node
\draw (82.27,273) node [anchor=north east] [inner sep=0.75pt]   [align=left] {$\displaystyle I^{-}$};
% Text Node
\draw (97.27,177) node [anchor=north east] [inner sep=0.75pt]   [align=left] {$\displaystyle I_{2}$};
