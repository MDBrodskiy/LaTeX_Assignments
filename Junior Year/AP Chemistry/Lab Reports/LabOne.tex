...
\section{Calculations}
    ...
    \begin{justify}
      ...
      The amount of \ce{NaCl} formed may be easily determined by finding the excess \ce{NaHCO3} and subtracting that from the change in the mass of the dish ($\Delta m_{dish}-m_{\ce{NaHCO3}}$ \eqref{eq1}):
    \end{justify}
...
\begin{justify}
  ...
  The results of this laboratory experiment demonstrate our percent yield as 74.4\%. Therefore, it is evident that this experiment yielded a lesser amount of Sodium Chloride (\ce{NaCl}), which is to be expected, given the limiting factor of Hydrochloric Acid (\ce{HCl}). 
