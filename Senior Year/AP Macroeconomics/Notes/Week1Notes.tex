            ...
            \begin{center}
                ...
                \begin{tikzpicture}
                  \begin{axis}[xmin=0, xlabel={Good $x$}, ylabel={Good $y$}, ymin=0, ymajorgrids=true, xmajorgrids=true, grid style=dashed]
                      ...
                      \node[label={180:{Efficient}},circle,fill,inner sep=2pt, color=blue] at (axis cs:3,4) {};
                      \node[label={180:{Feasible}},circle,fill,inner sep=2pt, color=green] at (axis cs:2,1) {};
                      \node[label={180:{Infeasible}},circle,fill,inner sep=2pt, color=red] at (axis cs:5,5) {};
                    \end{axis}
                \end{tikzpicture}
